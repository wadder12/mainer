...
const changelog = computed(() => {
	const flavoredString = (release[type.value].body ?? "")
		...
		.replace("https://github.com/wadder12/QuantaAI-Projects/releases", "/changelogs/")
...
<template>
	...
	<div class="fullChangelog">
		<p>
			...
			<a href="https://github.com/wadder12/QuantaAI-Projects/releases/latest" target="_blank" rel="noopener">
				here
			</a>
		</p>
	</div>
